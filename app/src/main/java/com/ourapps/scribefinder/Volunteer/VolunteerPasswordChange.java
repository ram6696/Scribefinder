...
import com.ourapps.scribefinder.Needy.NeedyData;
                        ...
                        user.updatePassword(confirmPassword).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    NeedyData newNeedyData = new NeedyData(volunteerData.getVolunteerId(), volunteerData.getName(), volunteerData.getEmail(), volunteerData.getMobileNumber(), etConfirmPassword.getText().toString().trim(), volunteerData.getAccountType(), volunteerData.getPhotoUrl());
